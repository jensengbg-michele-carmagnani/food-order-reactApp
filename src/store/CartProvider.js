...
// Is an obj as a defaulte State Cart
const defaultCartState = {
  items: [],
  totalAmount: 0,
};
// will not need any sorroiunding data and it shouln't be recreated all the time when the component is reacreated
const cartReducer = (state, action) => {
  ...
  if (action.type === 'REMOVE'){
    ...
    return {
      items: updatedItems,
      tolalAmount:updatedTotalAmount,
    }
  }
